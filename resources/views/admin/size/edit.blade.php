...
<div class="col-lg-6" style="align-self: center">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="user myForm" method="post" action="{{ route('updateSize') }}" enctype="multipart/form-data">
                @csrf()
                <input type="hidden" name="id" value="{{ $size->id }}">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="">Nama Ukuran</label>
                        <input type="text" name="namaUkuran" class="form-control form-control-user" value="{{ $size->size_name }}"
                            id="namaUkuran"
